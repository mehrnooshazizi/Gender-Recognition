...
model=Sequential()
model.add(Conv1D(96,5,activation='relu',padding='same',strides=4,input_shape=(100,100)))
#model.add(Dropout(0.2))
model.add(Conv1D(256,3,activation='relu',strides=2,padding='same'))
#model.add(Dropout(0.2))
model.add(Conv1D(384,3,activation='relu',strides=2,padding='same'))
#model.add(Dropout(0.2))
model.add(Conv1D(384,3,activation='relu',strides=1,padding='same'))
#model.add(Dropout(0.2)) 
model.add(Conv1D(384,3,activation='relu',strides=1,padding='same')) 
...
model.add(Dense(2,activation='sigmoid',activity_regularizer=L2(0.0005)))
